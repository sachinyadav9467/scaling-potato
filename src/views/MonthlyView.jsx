...
import { formatDate, getMonthDates, addMonthsToDate, subMonthsFromDate, isSameDate, startOfMonth, endOfMonth } from '../utils/dateUtils.js';
import { getMonthlyMetrics } from '../utils/metrics.js';
...
const MonthlyView = () => {
  ...
  const metrics = getMonthlyMetrics(currentDate);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Metrics */}
      <MetricsCard title="Monthly Metrics" metrics={metrics} type="monthly" />
      ...
      {/* Course Difficulty */}
      {metrics.courseDifficulty && Object.keys(metrics.courseDifficulty).length > 0 && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
