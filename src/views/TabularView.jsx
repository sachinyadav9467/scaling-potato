...
import { getAssignments, getAssignmentsForDate } from '../utils/data.js';
import { getCourse } from '../utils/data.js';
import { formatDate, isOverdue, getDaysUntilDue } from '../utils/dateUtils.js';
import { ASSIGNMENT_TYPES, ASSIGNMENT_STATUS } from '../types/index.js';
import { Search, Filter, Download } from 'lucide-react';

const TabularView = () => {
  const { courses, assignments, currentDate, setCurrentDate } = useApp();
